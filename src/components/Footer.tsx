...
const FOOTER_BLOCK_STYLE = "";
const FOOTER_TITLE_STYLE = "text-white pb-3";
const FOOTER_ITEM_STYLE = "text-neutral-grayishViolet pt-2";
const FOOTER_SOCIAL_ICON_STYLE = "mx-3";
...
const Footer = () => (
  <div className="bg-neutral-veryDarkBlue max-md:text-center md:flex py-10 ">
    ...
    <div className="w-full flex mt-7 h-7 justify-center">
      ...
      <Link to={"https://www.x.com/"} className={FOOTER_SOCIAL_ICON_STYLE}>
        <XLogo fill="#FFFFFF" />
      </Link>
